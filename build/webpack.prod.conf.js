...
const env = 'test'
// 打包时候  expert、SSO、usercenter 需要修改成https
if(['SSO','expert','usercenter','pskin3','mnskin','nskin','zhsq'].indexOf(website)!=-1){
...
const webpackConfig = merge(baseWebpackConfig, {
    ...
    output: {
        path:  path.join(config.build.assetsRoot,website),//config.build.assetsRoot,
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            'COOKIE_SUFFIX': JSON.stringify('-cc'),
        }),

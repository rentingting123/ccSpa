...
export default {
  ...
  methods: {
    ...
    toPath(list){
      if(list.childs && list.childs.length) {
        for(let i in list.childs){
          if(list.childs[i].show){
            return this.$router.push(list.childs[i].path)
          }
        }
        return;
      }
  ...
  created() {
    ...
    if(arr && arr.navsList){
      ...
      if(arr.navsList[5].childs && arr.navsList[5].childs[0] && arr.navsList[5].childs[0].show==false){
        this.$set(this.lists[1].childs[0],'show', false)
      }
      if(arr.navsList[5].childs && arr.navsList[5].childs[1] && arr.navsList[5].childs[1].show==false){
        this.$set(this.lists[1].childs[1],'show', false)
      }
      if(arr.navsList[5].childs && arr.navsList[5].childs[2] && arr.navsList[5].childs[2].show==false){
        this.$set(this.lists[1].childs[2],'show', false)
      }
    }
  },
  watch: {

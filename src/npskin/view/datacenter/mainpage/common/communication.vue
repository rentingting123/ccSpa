...
export default {
    ...
    async created(){
    //    if(localStorage.getItem('eventNewsletter')){
    //        this.lists = eval(localStorage.getItem('eventNewsletter'))
    //    }else{
            this.loading = true
            ...
            this.loading = false
            if(res=='error') return;
            localStorage.setItem('eventNewsletter',JSON.stringify(res.pageData))

...
export default {
  ...
  created() {
    ...
    if(arr && arr.navsList){
      ...
      if(arr.navsList[2].childs && arr.navsList[2].childs[0] && arr.navsList[2].childs[0].show==false){
        this.$set(this.lists[1].childs[0],'show', false)
      }
      if(arr.navsList[2].childs && arr.navsList[2].childs[1] && arr.navsList[2].childs[1].show==false){

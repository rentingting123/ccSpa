<template>
    <div class="layout">
        ...
        <tab-competition v-if="tabshow" :close="close"/>
    </div>
</template>

<script>
import HeaderComponent from "./common/header/header.vue"
import SideComponent from "./common/aside/aside.vue"
import tabCompetition from './common/tabCompetition'
export default {
    components:{
        HeaderComponent,
        SideComponent,
    ...
    mounted(){
        this.widthdataright = {
            display:"block",
            width: `calc(100% - ${this.widthnum}px)`,
        }

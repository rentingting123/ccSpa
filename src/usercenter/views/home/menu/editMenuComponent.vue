    ...
    export default {
        ...
        methods: {
            ...
            post (name) {
                ...
                if (this.formValidate.permCode!=this.formValidateCopy.permCode) {
                    data.permCode=this.formValidate.permCode
                }
                if (this.formValidate.status!=this.formValidateCopy.status) {
                    data.status=this.formValidate.status
                }
                if (this.formValidate.description!=this.formValidateCopy.description) {
                ...
                this.$api.put('/usercenter/permission',data).then(reset => {
                    if (reset.code === 0) {

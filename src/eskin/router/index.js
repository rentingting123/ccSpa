...
import mainpage from '@/eskin/components'
...
export default new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/newslist',
            name: 'newslist',
            component: resolve => require(['@/eskin/components/news/newslist'], resolve)
        },
        {
            path: '/newsdetail',
            name: 'newsdetail',
            component: resolve => require(['@/eskin/components/newsdetail'], resolve)
        },
        {
            path: '/competition',
            name: 'competition',
            component: resolve => require(['@/eskin/components/competition'], resolve)
        },
        {
            path: '/train',
            name: 'train',
            component: resolve => require(['@/eskin/components/training'], resolve)
        },
        {

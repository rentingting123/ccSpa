    ...
    <div class="login_modal">
      <div class="qrcode_login">
        <div class="login_head">
          <img src="https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/home/logo3.png" alt />
        ...
        <div class="login_phone" v-show="logPage=='phoneLogin'?true:false">
          ...
          <!-- <img
            ...
            src="https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/login/btm-wx.png"
            title="二维码登录"
            class="change_login_mode"
            @click="logPage='qrcodeLogin'"
          >
          <img
            src="https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/login/btm-pw.png"
            title="账号密码登录"
        ...
        <div class="login_phone" v-show="logPage=='schoolNum'?true:false">
          ...
          >
          <img
            src="https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/login/btm-phone2.png"
            title="手机号登录"
            class="change_login_modeTwo"
            @click="logPage='phoneLogin'"
          >-->
...
export default {
  ...
  methods: {
    ...
    async setUserInfo(){
      var result = await network.getUserInfo();
      ...
      localStorage.setItem("groupId", result.groupId || -1);
    ...
    async loginJump() {
      // 判断是否为个人
      // let normal = await network.loginCommon();
      // if(normal=='error') return localStorage.removeItem('login');
      
      await this.setUserInfo();
      this.$store.state.islogin = true;
      var url = decodeURIComponent(this.getParameterByName("url")) || "/";
      var doJump;
      if (/^http(s?):\/\//.test(url)) {
        // 绝对路径
    ...
    WxLogin() {
      ...
      let obj = new WxLogin({
        ...
        redirect_uri: `https://cc.moocollege.com?data=${url}`,
        ...
        href:"https://web.moocollege.com/edit/201978/bd6df88960f311e9bb8a00163e040299/l4AK5ArT_1562565458406/css2.css" // 外部css文件url，需要https
      });
    },
    //截取url值
    getQueryString(name) {
  ...
  .login_modal {
    ...
    .notice {
      ...
      .mess {
        ...
        width: 10px;
        height: 43px;
        background: url(https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/home/Line.png) no-repeat;

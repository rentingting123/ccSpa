        ...
        <div class="clearfix">
            <div>
                ...
                <div class="search">
                    ...
                    <!-- <p>
                        <span v-for='item,index in mainworlds' v-if="index<=3" @click="mainworld(`${item}`)">{{item}}</span>
                    </p> -->
                </div>
                <div class="phone">
...
export default {
    data(){
        return{
            searchName: '',
            logo: 'https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/header/logo2.png',
            mainworlds:[ ],
            tel: '0571-81902943',
...
.header{
    width: 100%;
    height: 80px;
    background: url(https://web.moocollege.com/mooc/hzq/vueskin/assets/provinceSkin/header/bg1.png) no-repeat;

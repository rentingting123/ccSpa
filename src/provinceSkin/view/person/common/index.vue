...
import invoice from '../../../components/meetingdetail/common/invoice/index'
import invoiceDetail from '../../../components/meetingdetail/common/invoice/detail'
import outlinepay from '../../../components/meetingdetail/common/pay/outline'

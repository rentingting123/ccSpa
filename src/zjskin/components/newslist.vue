<template>
    <div class="news">
        <h1 class="clearfix">
            <ul class="fl">
                <li :class="{'on':type==4}" @click="choose(4)">赛事资讯<p></p></li><span>/</span>
                <li :class="{'on':type==5}" @click="choose(5)">政策文件<p></p></li><span>/</span>
                <li :class="{'on':type==6}" @click="choose(6)">学生竞赛<p></p></li><span>/</span>
                <li :class="{'on':type==7}" @click="choose(7)">教发指数<p></p></li>
            </ul>
        </h1>
        <div class="clearfix">
...
export default {
    ...
    created(){
        this.type = this.$route.query.type?this.$route.query.type:4;
        this.init()
    },
    methods:{
        tonewsdetail(item){

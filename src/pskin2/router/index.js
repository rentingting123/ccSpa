...
import mainpage from '@/pskin2/components'
...
export default new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/newslist',
            name: 'newslist',
            component: resolve => require(['@/pskin2/components/newslist'], resolve)
        },
        {
            path: '/newsdetail',
            name: 'newsdetail',
            component: resolve => require(['@/pskin2/components/newsdetail'], resolve)
        },
        {
            path: '/competition',
            name: 'competition',
            component: resolve => require(['@/pskin2/components/competition'], resolve)
        },
        {
            path: '/train',
            name: 'train',
            component: resolve => require(['@/pskin2/components/training'], resolve)
        },
        {
        ...
        },
        {
            ...
            name: 'schooldetail',
            component: resolve => require(['@/pskin2/components/school'], resolve)
        },
        {
            path: '/search/:name',
            name: 'search',

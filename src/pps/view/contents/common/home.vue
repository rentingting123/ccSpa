    ...
    <div class="right" style="text-align: left">
      <el-form size="small" :inline="true" :model="formData" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <FileImport
            action="/api/contentdata/importdata"
          > 导入数据</FileImport>
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="admodeTime" label="采集时间">
          <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      let res = await network.getconlist({ data: this.formData });
      if (res == "error") return;

...
import mainpage from '@/pskin4/view/mainpage'
...
let router = new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/newslist',
            name: 'newslist',
            component: resolve => require(['@/pskin4/view/newslist'], resolve)
        },
        {
            path: '/newsdetail',
            name: 'newsdetail',
            component: resolve => require(['@/pskin4/view/newsdetail'], resolve)
        },
        {
            path: '/competition',
            name: 'competition',
            component: resolve => require(['@/pskin4/view/competition'], resolve)
        },
        {
            path: '/train',
            name: 'train',

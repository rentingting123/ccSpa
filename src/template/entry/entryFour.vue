  ...
  <div class="skin2">
    ...
    <div class="ContestPurpose">
      <div v-for="(item,index) in blockRow" :key="index" class="ContestPurposeDetail">
        ...
        <div @click="$router.push('/details/entryGuide')" v-if='item==2'>
      ...
      <div@click="$router.push({name:'manual',query:{url:encodeURIComponent(skin.pdf)}})" v-if='item==3'>
